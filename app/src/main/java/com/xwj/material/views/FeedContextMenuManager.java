...
import com.xwj.material.views.FeedContextMenu.OnFeedContextMenuItemClickListener;
...
public class FeedContextMenuManager extends RecyclerView.OnScrollListener implements View.OnAttachStateChangeListener {
    ...
    protected void showContextMenuFromView(final View openingView, int feedItem,
    ...
    private void setupContextMenuInitialPosition(View openingView) {
        ...
        int additionalBottomMargin = PhoneUtils.dip2px(openingView.getContext(), 16);
